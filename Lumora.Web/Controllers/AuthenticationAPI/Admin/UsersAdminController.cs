namespace Lumora.Web.Controllers.AuthenticationAPI.Admin
{
    ...
    public class UsersAdminController(
            ...
            IUserActivationService authenticationService,
            GeneralMessage messages) : AuthenticatedController
    {
        ...
        private readonly IUserActivationService _authenticationService = authenticationService;
        ...
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> GetAll([FromQuery] PaginationRequestDto pagination, bool isActive, CancellationToken cancellationToken)
        {
            try
            {
                var userCheck = CheckUserOrUnauthorized();
