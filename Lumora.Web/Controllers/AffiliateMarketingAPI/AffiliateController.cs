namespace Lumora.Web.Controllers.AffiliateMarketingAPI
{
        ...
        ILogger<AffiliateController> logger, AffiliateMessage messages, IAffiliateService affiliateService) : AuthenticatedController
    {
        ...
        protected string CurrentUserAgent => Request.Headers["User-Agent"].ToString() ?? "Unknown";
        ...
        public async Task<IActionResult> Create([FromBody] PromoCodeCreateDto dto, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _affiliateService.CreatePromoCodeAsync(dto, CurrentUserId!, cancellationToken, CurrentUserIp, CurrentUserAgent);
        ...
        public async Task<IActionResult> RegisterUsage([FromQuery] int paymentId, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _affiliateService.RegisterPromoCodeUsageAsync(paymentId, cancellationToken, CurrentUserIp, CurrentUserAgent);
        ...
        public async Task<IActionResult> DeactivateAll(CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _affiliateService.DeactivateAllPromoCodesAsync(CurrentUserId!, cancellationToken, CurrentUserIp, CurrentUserAgent);
        ...
        public async Task<IActionResult> Reactivate([FromRoute] int promoCodeId, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _affiliateService.ReactivatePromoCodeAsync(promoCodeId, CurrentUserId!, cancellationToken, CurrentUserIp, CurrentUserAgent);
