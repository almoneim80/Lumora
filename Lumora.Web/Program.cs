    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            AppSettingsFiles.ForEach(path =>
            {
                ...
                Serilog.Log.Information("AppSettingsFile", path + " loaded.");
            });
            ...
            var emailSettings = builder.Configuration.GetSection("AppSettings").Get<EmailSettings>();
            ...
            builder.Services.AddDbContext<PgDbContext>(options => options.UseNpgsql(connectionString).UseLazyLoadingProxies());
