        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    web_domain_id = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_dns_record", x => new { x.domain_name, x.value, x.record_type });
                    table.ForeignKey(
                        name: "fk_dns_record_domain_web_domain_id",
                        column: x => x.web_domain_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reason = table.Column<string>(type: "text", nullable: false),
                    contact_id = table.Column<int>(type: "integer", nullable: true),
                    contact_id1 = table.Column<int>(type: "integer", nullable: true),
                    created_by_ip = table.Column<string>(type: "text", nullable: true),
                    created_by_id = table.Column<string>(type: "text", nullable: true),
                    created_by_user_agent = table.Column<string>(type: "text", nullable: true),
                    source = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_unsubscribe_contact_contact_id1",
                        column: x => x.contact_id1,
                        principalTable: "contact",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_dns_record_web_domain_id",
                table: "dns_record",
                column: "web_domain_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_unsubscribe_contact_id1",
                table: "unsubscribe",
                column: "contact_id1");
