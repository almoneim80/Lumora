namespace Lumora.Application.Services.PaymentSvc
{
    public class PaymentService(
        ...
        IEnrollmentService enrollmentService) : IPaymentService
    {
        ...
        public async Task<GeneralResult<PaymentStartResultDto>> StartPaymentAsync(PaymentCreateDto dto)
        {
            try
            {
                ...
                var userExists = await _userRepository.ExistsByIdActiveAsync(dto.UserId);
                if (!userExists)
                {
