namespace Lumora.Application.DTOs.Test;
...
#nullable enable
    ...
    public IFileStream? CourseLogo { get; set; }
}
...
public class LessonWithContentCreateFormDto
{
    ...
    public IFileStream? LessonVideo { get; set; }

    public List<IFileStream>? Attachments { get; set; }
}
