namespace Lumora.Application.Mappings
{
    public class TrainingProgramProfile : AutoMapper.Profile
    {
        public TrainingProgramProfile()
        {
            ...
            CreateMap<TrainingProgram, TrainingProgramUpdateDto>().ForAllMembers(m => m.Condition(MappingConditions.PropertyNeedsMapping));
            CreateMap<TrainingProgramUpdateDto, TrainingProgram>().ForAllMembers(m => m.Condition(MappingConditions.PropertyNeedsMapping));

            // details
            CreateMap<TrainingProgram, TrainingProgramFullDetailsDto>().ForAllMembers(m => m.Condition(MappingConditions.PropertyNeedsMapping));
