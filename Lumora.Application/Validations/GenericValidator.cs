namespace Lumora.Application.Validations
{
    public static class GenericValidator
    {
            ...
            this IRuleBuilder<T, TProperty> ruleBuilder)
        {
            return (IRuleBuilderOptions<T, TProperty>)ruleBuilder.Custom((value, context) =>
            {
                ...
                {
                    context.AddFailure($"The field '{context.PropertyPath}' cannot be null, empty, contain only spaces, or be the default value (e.g., 0 for numbers).");
                }
            });
        }
