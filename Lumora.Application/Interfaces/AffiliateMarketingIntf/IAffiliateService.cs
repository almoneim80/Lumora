namespace Lumora.Application.Interfaces.AffiliateMarketingIntf
{
    public interface IAffiliateService
    {
        ...
        /// </summary>
        Task<GeneralResult> CreatePromoCodeAsync(PromoCodeCreateDto dto, string userId, CancellationToken cancellationToken, string createdByIp, string createdByAgent);
        ...
        /// </summary>
        Task<GeneralResult> RegisterPromoCodeUsageAsync(int paymentId, CancellationToken cancellationToken, string createdByIp, string createdByAgent);
        ...
        /// </summary>
        Task<GeneralResult> DeactivateAllPromoCodesAsync(string performedByUserId, CancellationToken cancellationToken, string createdByIp, string createdByAgent);
        ...
        /// </summary>
        Task<GeneralResult> ReactivatePromoCodeAsync(int promoCodeId, string performedByUserId, CancellationToken cancellationToken, string createdByIp, string createdByAgent);
    }
}
