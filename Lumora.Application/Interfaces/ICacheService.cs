namespace Lumora.Application.Interfaces
{
    public interface ICacheService
    {
        ...
        /// </summary>
        void Set<T>(string key, T value, TimeSpan expirationTime, bool useSlidingExpiration = false, CachePriority priority = CachePriority.Normal, long? size = null);
        ...
        /// </summary>
        Task SetAsync<T>(string key, T value, TimeSpan expirationTime, bool useSlidingExpiration = false, CachePriority priority = CachePriority.Normal, long? size = null);
    }
}
