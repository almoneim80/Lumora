namespace Lumora.Application.Interfaces.TestIntf
{
    public interface ITestQuestionService
    {
        ...
        Task<GeneralResult> UpdateQuestionAsync(int questionId, TestQuestionUpdateDto dto, CancellationToken cancellationToken);
        ...
        Task<GeneralResult<QuestionDetailsDto>> GetQuestionByIdAsync(int questionId, CancellationToken cancellationToken);
        ...
        Task<GeneralResult<PagedResult<QuestionDetailsDto>>> GetQuestionsByTestIdAsync(int testId, PaginationRequestDto pagination, CancellationToken cancellationToken);
