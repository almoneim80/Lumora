namespace Lumora.Application.Interfaces.Club
{
    public interface IPostService
    {
        ...
        Task<GeneralResult> CreateAsync(PostCreateDto dto, string userId, CancellationToken cancellationToken, string createdByIp, string createdByAgent);
