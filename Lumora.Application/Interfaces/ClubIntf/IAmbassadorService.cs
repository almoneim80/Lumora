namespace Lumora.Domain.Interfaces.ClubIntf
{
    public interface IAmbassadorService
    {
        ...
        /// </returns>
        Task<GeneralResult> AssignAmbassadorAsync(AmbassadorAssignDto dto, string adminId, CancellationToken cancellationToken, string createdByIp, string createdByAgent);
