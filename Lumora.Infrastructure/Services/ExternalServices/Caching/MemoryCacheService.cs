namespace Lumora.Services
{
    public class MemoryCacheService : ICacheService
    {
        ...
        /// <inheritdoc/>
        public void Set<T>(string key, T value, TimeSpan expirationTime, bool useSlidingExpiration = false, CachePriority priority = CachePriority.Normal, long? size = null)
        {
            try
            {
                ...
                {
                    Priority = (CacheItemPriority)priority,
                };
        ...
        /// <inheritdoc/>
        public async Task SetAsync<T>(string key, T value, TimeSpan expirationTime, bool useSlidingExpiration = false, CachePriority priority = CachePriority.Normal, long? size = null)
        {
            try
            {
                _logger.LogInformation("Cache: Setting value for key: {Key}", key);
