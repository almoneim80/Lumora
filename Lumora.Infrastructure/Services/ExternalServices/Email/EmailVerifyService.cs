namespace Lumora.Infrastructure.Services.ExternalServices.Email
{
    public class EmailVerifyService : IEmailVerifyService
    {
        ...
        private readonly IWebDomainService domainService;
        private readonly IEmailValidationExternalService emailValidationExternalService;

        public EmailVerifyService(PgDbContext pgDbContext, IWebDomainService domainService, IEmailValidationExternalService emailValidationExternalService)
        {
        ...
        public async Task<WebDomain> Verify(string email)
        {
            ...
            else
            {
                ...
                if (domain is null)
                {
                    domain = new WebDomain() { Name = domainName, Source = email };
        ...
        public async Task VerifyDomain(string email, WebDomain domain)
        {
