namespace Lumora.Infrastructure.BackgroundJobs
{
    public class WebDomainVerificationTask : BaseTask
    {
        ...
        public WebDomainVerificationTask(PgDbContext dbContext, IConfiguration configuration, IWebDomainService domainService, TaskStatusService taskStatusService)
