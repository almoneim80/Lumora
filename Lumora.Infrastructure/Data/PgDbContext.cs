...
namespace Lumora.Infrastructure.Data
{
    ...
    /// PgDbContext Class.
    /// </summary>
    public partial class PgDbContext : IdentityDbContext<User>, IUnitOfWork
    {
        ...
        public virtual DbSet<WebDomain> Domains { get; set; } = null!;
                ...
                foreach (var entityEntry in entries)
                {
                    ...
                    if (entityType!.GetCustomAttributes<SupportsChangeLogAttribute>().Any())
                    {
                        ...
                        changes[entityEntry] = new ChangeLog
                        {
                            ...
                            EntityState = (ObjectState)entityEntry.State,
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            try
            {
                ...
                optionsBuilder.UseNpgsql(
                    ...
                    .UseSnakeCaseNamingConvention().ReplaceService<IMigrationsSqlGenerator, CustomSqlServerMigrationsSqlGenerator>();
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Domain.Entities.Tables.Job>()
            ...
            builder.Entity<StaticContent>()
                .HasIndex(s => new { s.Key, s.Language })
            ...
            builder.Entity<DnsRecord>().HasKey(d => new { d.DomainName, d.Value, d.RecordType });
            ...
            builder.Entity<IpDetails>().HasIndex(u => u.Ip).IsUnique();
            builder.Entity<MailServer>().HasIndex(u => u.Name).IsUnique();
            builder.Entity<WebDomain>().HasIndex(u => u.Name).IsUnique();

            builder.Entity<Contact>().Property(b => b.SocialMedia).HasColumnType("jsonb");

            builder.Entity<Contact>(entity =>
            {
                entity.HasOne(c => c.Domain).WithMany().HasForeignKey(c => c.DomainId).OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(c => c.Unsubscribe).WithMany().HasForeignKey(c => c.UnsubscribeId).OnDelete(DeleteBehavior.SetNull);
            });
            ...
            builder.Entity<TrainingProgram>(entity =>
            {
                ...
                entity.Property(p => p.Trainers).HasConversion(
                    v => JsonSerializer.Serialize(v, (JsonSerializerOptions?)null),
